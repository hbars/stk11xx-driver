...
int dev_stk6d51_initialize_device(struct usb_stk11xx *dev)
{
	...
	dev_stk6d51_configure_device(dev, 0);
	...
	dev_stk6d51_configure_device(dev, 1);
...
int dev_stk6d51_configure_device(struct usb_stk11xx *dev, int step)
{
	...
	STK_DEBUG("dev_stk6d51_configure_device : %d\n", step);
	...
	switch (step) {
		...
		case 1:
			...
			dev_stk6d51_sensor_settings(dev);

			usb_stk11xx_read_registry(dev, 0x0000, &value);
			usb_stk11xx_write_registry(dev, 0x0200, 0x0021);
...
int dev_stk6d51_sensor_settings(struct usb_stk11xx *dev)
{
	...
	static const int values_205[][4] = {
		...
		{ 0x33, 0x90, 0x00, 0x24 },
		{ 0x33, 0x8c, 0xa2, 0x15 },
		{ 0x33, 0x90, 0x00, 0x02 }, // 0x04 or 0x02
		{ 0x33, 0x8c, 0xa2, 0x0d },
		{ 0x33, 0x90, 0x00, 0x10 }, // 0x30 or 0x10
		{ 0x33, 0x8c, 0xa2, 0x0e },
		{ 0x33, 0x90, 0x00, 0x80 },
		{ 0x33, 0x8c, 0xa1, 0x03 },
		{ 0x33, 0x90, 0x00, 0x05 },
